...
<?php if($pathway):?>
  <h4 style="font-size:200%;display:inline;"><?php echo $pathway['title'];?></h4>
  <span style="padding:0 0 0 20px"><a target="_blank" href="http://www.kegg.jp/kegg-bin/show_pathway?org_name=hsa&mapno=<?php echo $pathway['pathway_id'];?>">hsa:<?php echo $pathway['pathway_id'];?></a></span>
  ...
  <table class="full">
    ...
    <tr>
      ...
      <?php if(isset($pathway['enriched_by'][3])):?>
        <td><?php echo $pathway['enriched_by'][3]->count ?></td>
        <td><?php echo $pathway['enriched_by'][3]->percents ?></td>
        <td><?php echo $pathway['enriched_by'][3]->adj_p_value ?></td>
      <?php else:?>
        <td>NA</td>
        <td>NA</td>
        <td>NA</td>
    ...
    <tr>
      ...
      <?php if(isset($pathway['enriched_by'][1])):?>
        <td><?php echo $pathway['enriched_by'][1]->count ?></td>
        <td><?php echo $pathway['enriched_by'][1]->percents ?></td>
        <td><?php echo $pathway['enriched_by'][1]->adj_p_value ?></td>
      <?php else:?>
        <td>NA</td>
        <td>NA</td>
        <td>NA</td>
    ...
    <tr>
      ...
      <?php if(isset($pathway['enriched_by'][2])):?>
        <td><?php echo $pathway['enriched_by'][2]->count ?></td>
        <td><?php echo $pathway['enriched_by'][2]->percents ?></td>
        <td><?php echo $pathway['enriched_by'][2]->adj_p_value ?></td>
      <?php else:?>
        <td>NA</td>
        <td>NA</td>
        <td>NA</td>
	...
	<?php if($gene_in_pathway):?>
	<script type="text/javascript">
	<!--
		$(document).ready(function(){
			Genes('<?php echo $gene_in_pathway['symbol'];?>');
			$("#more").click(function(){
				currentMaxPoint += 20;
				Genes('<?php echo $gene_in_pathway['symbol'];?>',currentMaxPoint);
			});
			$("#less").click(function(){
				currentMaxPoint -= 20;
